...
(function() {
	...
	(function(Genre, obj) {
		...
		{
			lookouts: [0, 0, "Lookouts", "lookouts"],
			japanesesums: [0, 0, "Japanese Sums", "Japanese Sums"],
			pata: [0, 0, "Pata", "Pata"],
			transparenttapa: [0, 0, "Transparent Tapa", "Transparent Tapa"]
		}
	);
})();
	...
	KeyEvent: {
		...
		moveTC: function(ca, mv) {
			...
			switch (ca) {
				case "up":
					if (
						(this.pid === "easyasabc2" && cursor.by === -1) ||
	...
	"TargetCursor:Address": {
		...
		setaddr: function(pos) {
			...
			if (
				pos.bx < this.minx ||
				this.maxx < pos.bx ||
				pos.by < this.miny - (this.pid === "easyasabc2" ? 2 : 0) ||
				this.maxy < pos.by
			) {
				return;
			}
